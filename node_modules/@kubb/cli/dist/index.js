...
import { t as version } from "./package-DOoCSchC.js";
...
async function run(argv = process.argv) {
	...
	const [{ command: generateCommand }, { command: validateCommand }, { command: mcpCommand }, { command: agentCommand }, { command: initCommand }] = await Promise.all([
		import("./generate-BjksloS3.js"),
		import("./validate-DDEzYbDZ.js"),
		import("./mcp-rCGsuaWb.js"),
		import("./agent-D_JDFk_t.js"),
		import("./init-BhDyPP6M.js")
	]);
	await cli.run([
		generateCommand,
		validateCommand,
