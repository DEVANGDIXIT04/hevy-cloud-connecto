...
const require_package = require("./package-CXinXKRX.cjs");
...
async function run(argv = process.argv) {
	...
	const [{ command: generateCommand }, { command: validateCommand }, { command: mcpCommand }, { command: agentCommand }, { command: initCommand }] = await Promise.all([
		Promise.resolve().then(() => require("./generate-CxI7VjlX.cjs")),
		Promise.resolve().then(() => require("./validate-CtZ5uwEZ.cjs")),
		Promise.resolve().then(() => require("./mcp-BKLBwnwB.cjs")),
		Promise.resolve().then(() => require("./agent-BaRFyk6N.cjs")),
		Promise.resolve().then(() => require("./init-CwBkr0OO.cjs"))
	]);
	await cli.run([
		generateCommand,
		validateCommand,
